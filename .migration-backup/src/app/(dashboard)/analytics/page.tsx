...
const HabitCompletionChart = dynamic(
  () => import("@/components/analytics/HabitCompletionChart").then((mod) => mod.HabitCompletionChart),
  { ssr: false, loading: () => <div className="h-[350px] animate-pulse rounded-xl border border-border/60 bg-card/30" /> }
);

const HabitPieChart = dynamic(
  () => import("@/components/analytics/HabitPieChart").then((mod) => mod.HabitPieChart),
  { ssr: false, loading: () => <div className="h-[350px] animate-pulse rounded-xl border border-border/60 bg-card/30" /> }
);

const WeeklyBarChart = dynamic(
  () => import("@/components/analytics/WeeklyBarChart").then((mod) => mod.WeeklyBarChart),
  { ssr: false, loading: () => <div className="h-[300px] animate-pulse rounded-xl border border-border/60 bg-card/30" /> }
);

const StreakChart = dynamic(
  () => import("@/components/analytics/StreakChart").then((mod) => mod.StreakChart),
  { ssr: false, loading: () => <div className="h-[300px] animate-pulse rounded-xl border border-border/60 bg-card/30" /> }
);

const FocusTimeChart = dynamic(
  () => import("@/components/analytics/FocusTimeChart").then((mod) => mod.FocusTimeChart),
  { ssr: false, loading: () => <div className="h-[300px] animate-pulse rounded-xl border border-border/60 bg-card/30" /> }
);
